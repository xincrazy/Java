...
/**
 * Internal ElasticSearch client factory. Responsible for creating instance of ElasticSearch
 * clients.
 */
public class ElasticSearchClientFactory {
     ...
     * @param retry
     *            bulk request failed retry times
     * @param serializer
    ...
    public ElasticSearchClient getClient(String clientType,
        ...
        if (clientType.equalsIgnoreCase(TransportClient) &&
            serializer != null) {
            return new ElasticSearchTransportClient(hostNames,
                                                    clusterName,
                                                    retry,
                                                    serializer);
        } else if (clientType.equalsIgnoreCase(TransportClient) &&
                   indexBuilder != null) {
            return new ElasticSearchTransportClient(hostNames,
                                                    clusterName,
                                                    retry,
