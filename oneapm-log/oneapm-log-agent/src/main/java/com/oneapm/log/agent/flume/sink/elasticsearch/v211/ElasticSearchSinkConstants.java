...
public class ElasticSearchSinkConstants {
    ...
    /**
     * Comma separated list of hostname:port, if the port is not present the default port '9300'
     * will be used</p> Example:
     * 
     * <pre>
    ...
    /**
     * The name to index the document to, defaults to 'flume'</p> The current date in the format
     * 'yyyy-MM-dd' will be appended to this name, for example 'foo' will result in a daily index of
     * 'foo-yyyy-MM-dd'
     */
    ...
    /**
     * Maximum times to retry failed bulk request
     */
    public static final String RETRY_TIMES                      = "retryTimes";
    
    /**
     * TTL in days, when set will cause the expired documents to be deleted automatically, if not
     * set documents will never be automatically deleted
     */
    ...
    /**
     * The fully qualified class name of the index name builder the sink should use to determine
     * name of index where the event should be sent.
     */
    ...
    public static final String DEFAULT_SERIALIZER_CLASS         = "com.oneapm.log.agent.flume.sink.elasticsearch.v211.serializer.ElasticSearchSourceSerializer";
    public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS = "com.oneapm.log.agent.flume.sink.elasticsearch.v211.TimeBasedIndexNameBuilder";
}
