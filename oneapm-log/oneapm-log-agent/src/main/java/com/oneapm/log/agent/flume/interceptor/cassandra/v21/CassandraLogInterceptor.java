...
public class CassandraLogInterceptor implements Interceptor, Constants {
	...
	public Event intercept(Event event) {
		...
		if (eventBodyStr.contains("#") || eventBodyStr.isEmpty()) {
			return null;
		}
	 ...
	 */
	public static class CassandraLogInterceptorBuilder implements Interceptor.Builder {
		...
		public void configure(Context context) {
			...
			this.cassandraType = context.getString(CASSANDRA_PATH);
		}

		public Interceptor build() {
			logger.debug("building CassandraLogInterceptor...");
			return new CassandraLogInterceptor(metricType, cassandraType);
		}
	}
}
