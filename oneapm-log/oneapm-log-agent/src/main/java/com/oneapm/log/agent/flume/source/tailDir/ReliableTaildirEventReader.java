...
package com.oneapm.log.agent.flume.source.tailDir;
...
public class ReliableTaildirEventReader implements ReliableEventReader {
  ...
  private ReliableTaildirEventReader(Map<String, String> filePaths,
    ...
    logger.debug("taildirCache: " + taildirCache.toString());
    logger.debug("headerTable: " + headerTable.toString());
    ...
    logger.debug("Updating position from position file: " + positionFilePath);
  ...
  public void loadPositionFile(String filePath) {
    ...
    try {
      ...
      logger.debug("File not found: " + filePath + ", not updating position");
    } catch (IOException e) {
  ...
  private TailFile openFile(File file, Map<String, String> headers, long inode, long pos) {
    try {
      logger.debug("Opening file: " + file + ", inode: " + inode + ", pos: " + pos);
