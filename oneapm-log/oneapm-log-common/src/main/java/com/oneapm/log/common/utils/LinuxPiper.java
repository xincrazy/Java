...
public class LinuxPiper implements java.lang.Runnable {

    private java.io.InputStream input;

    private java.io.OutputStream output;

    public LinuxPiper(java.io.InputStream input, java.io.OutputStream output) {
        this.input = input;
        this.output = output;
    }
    ...
    public static java.io.InputStream pipe(java.lang.Process... proc) throws java.lang.InterruptedException {
        ...
        for (int i = 0; i < proc.length; i++) {
            ...
            if (i + 1 < proc.length) {
                p2 = proc[i + 1];
                // Start piper
                new Thread(new LinuxPiper(p1.getInputStream(), p2.getOutputStream())).start();
            }
        }
