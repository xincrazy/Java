...
/**
 * Interface for creating ElasticSearch {@link IndexRequestBuilder} instances from serialized flume
 * events. This is configurable, so any config params required should be taken through this.
 */
