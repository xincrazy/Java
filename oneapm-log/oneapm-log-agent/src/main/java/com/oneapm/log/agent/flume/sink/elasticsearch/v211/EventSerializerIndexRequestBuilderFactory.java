...
/**
 * Default implementation of {@link ElasticSearchIndexRequestBuilderFactory}. It serializes flume
 * events using the {@link ElasticSearchEventSerializer} instance configured on the sink.
 */
public class EventSerializerIndexRequestBuilderFactory extends AbstractElasticSearchIndexRequestBuilderFactory {
    ...
    public EventSerializerIndexRequestBuilderFactory(ElasticSearchEventSerializer serializer) {
        this(serializer,
             ElasticSearchIndexRequestBuilderFactory.df);
    }
