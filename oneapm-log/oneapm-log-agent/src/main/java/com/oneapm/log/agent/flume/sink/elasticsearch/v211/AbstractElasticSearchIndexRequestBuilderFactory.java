...
/**
 * Abstract base class for custom implementations of {@link ElasticSearchIndexRequestBuilderFactory}
 * .
 */
public abstract class AbstractElasticSearchIndexRequestBuilderFactory implements ElasticSearchIndexRequestBuilderFactory {
    
    /**
     * {@link FastDateFormat} to use for index names in {@link #getIndexName(String, long)}
     */
    ...
    /**
     * Creates and prepares an {@link IndexRequestBuilder} from the supplied {@link Client} via
     * delegation to the subclass-hook template methods {@link #getIndexName(String, long)} and
    ...
    public IndexRequestBuilder createIndexRequest(Client client,
        ...
        String indexName = getIndexName(realIndexPrefix,
                                        timestamp);
        prepareIndexRequest(request,
                            indexName,
                            realIndexType,
                            timestampedEvent);
        return request;
     ...
     */
    protected abstract void prepareIndexRequest(IndexRequestBuilder indexRequest,
                                                String indexName,
                                                String indexType,
                                                Event event) throws IOException;
