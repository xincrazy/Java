...
/**
 * Interface for an event serializer which serializes the headers and body of an event to write them
 * to ElasticSearch. This is configurable, so any config params required should be taken through
 * this.
 */
