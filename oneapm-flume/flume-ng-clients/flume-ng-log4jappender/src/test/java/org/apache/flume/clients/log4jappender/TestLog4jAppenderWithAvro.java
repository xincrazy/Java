...
public class TestLog4jAppenderWithAvro {
  ...
  public void setUp() throws Exception {
    ...
    // <2016.07.01, liuqiyun> Updated here as upgrade guava version from 11.0.2 to 18.0 for avoid conflicts with elasticsearch2.1
    // And this test could pass after modification
    
//    Files.copy(Resources.newInputStreamSupplier(schemaUrl),
//        new File("/tmp/myrecord.avsc"));
    
    Files.write(Resources.asByteSource(schemaUrl).read(),
            new File("/tmp/myrecord.avsc"));
